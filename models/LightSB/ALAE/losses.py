...
__all__ = [
    "kl",
    "reconstruction",
    "discriminator_logistic_simple_gp",
    "discriminator_gradient_penalty",
    "generator_logistic_non_saturating",
]
...
def discriminator_logistic_simple_gp(
    d_result_fake, d_result_real, reals, r1_gamma=10.0
):
    ...
    if r1_gamma != 0.0:
        ...
        real_grads = torch.autograd.grad(
            real_loss, reals, create_graph=True, retain_graph=True
        )[0]
